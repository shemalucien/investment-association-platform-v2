...
export default function TreasurerReportsPage() {
  ...
  const handleSendMonthlyReport = async () => {
    ...
    try {
      ...
      const recipient = adminMember || members.find((member) => member.role === "treasurer") || members[0]

      if (!recipient) {
        console.warn("[v0] No recipient member is available for the report.")
        return
      }
      ...
      formData.append("relatedEntityId", "monthly")
      if (attachedFile) {
                ...
                <CardHeader>
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <CardDescription>Send monthly financial reports to admin</CardDescription>
                    </div>
                  </div>
                </CardHeader>
                <CardContent>
                  {reportSent ? (
                    <div className="text-center py-8">
                      ...
                      <p className="text-sm text-muted-foreground mb-4">
                        The monthly report has been sent to the admin.
                      </p>
                    ...
                    <div className="space-y-4">
                      ...
                      <Button
                        ...
                        disabled={!reportTitle || !reportMessage || isSending}
                      >
