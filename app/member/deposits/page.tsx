...
import { Wallet, CheckCircle2, History } from "lucide-react"
...
export default function MemberDepositsPage() {
    ...
    const fetchData = async () => {
      try {
        const [depositsData, accountsData] = await Promise.all([
          apiGet<any[]>(`/api/deposits?memberId=${user?.id}`),
  ...
  const handleDepositClick = async () => {
    ...
    try {
      ...
      // Refresh from server to get accurate history
      const refreshed = await apiGet<any[]>(`/api/deposits?memberId=${user?.id}`)
                ...
                <div className="flex flex-col items-center text-center space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-green-700 dark:text-green-300 mt-2">
                      Your deposit has been recorded successfully. Thank you for your contribution.
                    </p>
                  </div>
            ...
            <Card>
              <CardHeader>
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <div>
                    ...
                    <CardDescription>Contribute to your cooperative savings</CardDescription>
                  </div>
                </div>
              </CardHeader>
              <CardContent className="space-y-4">
                ...
                <Button
                  ...
                  disabled={!amount || !paymentMethod || !cooperativeAccount || isSubmitting}
                >
              ...
              <CardHeader>
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <div>
                    ...
                    <CardDescription>Your deposit transactions in Rwandan Francs</CardDescription>
                  </div>
                </div>
              </CardHeader>
              <CardContent>
